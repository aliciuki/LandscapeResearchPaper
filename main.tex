...
\articletype{Taylor \& Francis \LaTeX\ template for authors (\textsf{Interact} layout + American Psychological Association reference style)}% Specify the article type or omit as appropriate

\title{Tales from Anatolia: Landscape Research paper}

\author{
\name{Simay Kırca\textsuperscript{a}\thanks{CONTACT Simay Kırca. Email: simay.kirca@gmail.com}, Stephen Chignell,\textsuperscript{b} Andrew Schuldt,\textsuperscript{b} and Alicia Urquidi Díaz\textsuperscript{b}}
\affil{\textsuperscript{a}Department of Landscape Planning and Design, Istanbul University-Cerrahpaşa; \textsuperscript{b}University of British Columbia, Vancouver, Canada.}
}
\maketitle
